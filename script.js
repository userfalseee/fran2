...
let indiceActual = 0;
let indiceActual__gatos = 0;

function cambiarImagen() {
    const imgElement = document.getElementById('imagenCambiable');
    indiceActual = (indiceActual + 1) % imagenes.length; // update index
    imgElement.src = imagenes[indiceActual]; 
}

function cambiarImagen__gatos() {
    const imgElement = document.getElementById('gatos');
    indiceActual__gatos = (indiceActual__gatos + 1) % imagenes__gatos.length; // update index
    imgElement.src = imagenes__gatos[indiceActual__gatos]; 
}

setInterval(cambiarImagen, 2500);
setInterval(cambiarImagen__gatos, 4000);
